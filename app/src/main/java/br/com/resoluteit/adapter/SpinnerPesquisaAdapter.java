...
public class SpinnerPesquisaAdapter extends ArrayAdapter<PesquisaPreco> {

    private List<PesquisaPreco> mData;
    public Resources mResources;
    private LayoutInflater mInflater;


    public SpinnerPesquisaAdapter(
            Activity activitySpinner,
            int textViewResourceId,
            List<PesquisaPreco> objects,
            Resources resLocal
    ) {
    ...
    @Nullable
    @Override
    public PesquisaPreco getItem(int position) {
